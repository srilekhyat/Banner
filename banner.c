...
void	getBanner()
{
	...
	printf("Please enter a String to Display in Banner:\n");
	gets(AlphaStr);
	printf("Enter the Character to use for Banner (Example: * or #):");
	scanf("%c", &DispChar);
	printf("\n\n");	
	...
	for (Row=0; Row<7; Row++)
	{
		for (i=0; i<Len; i++)
		{
			...
			DisplayBannerRow(Width, Num);
		}
		printf("\n");
	}
}

void	DisplayBannerRow(int Width, int Num)
{
